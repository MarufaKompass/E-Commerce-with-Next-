...
export function Navbar() {
  return (
    <section className=" border-b border-border/50">
      <nav className="container mx-auto fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 bg-background/80 backdrop-blur-md">
        <div className="flex items-center gap-8">
          <Link href="/" className="text-xl font-serif tracking-widest font-bold">
            LUXE
          </Link>
